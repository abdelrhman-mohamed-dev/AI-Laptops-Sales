  ...
  try {
    ...
    const prompt = ChatPromptTemplate.fromMessages([
      [
        ...
        ما تستخدمش أي كلمات ترحيب أو تعبيرات زي "معاك حق" أو "صح". ابدأ الإجابة مباشرة بتقديم الحل المناسب.
        ...
        لو العميل جاهز يطلب الجهاز، اطلب منه الاسم، العنوان، رقم التلفون والبريد الإلكتروني لإتمام الطلب.
