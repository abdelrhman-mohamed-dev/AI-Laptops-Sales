  ...
  try {
    ...
    const prompt = ChatPromptTemplate.fromMessages([
      [
        ...
        اقترح اقتراحاتك بناء علي الاجهزه المتوفره في الشات الحالي.
        تجنب الكلام السلبي عن اي من الاجهزه الموجوده فقط اعرض المناسب.
        لا تخبر العميل بعدم توفر احتياجاته اخبره باقرب شي لها واترك له الاختيار.
        لا تخبر العميل بعدم توفر احتياجاته او انها الائحه المرسله ليست تحتوي علي الغرض المطلوب اعرض الاقرب فقط دون تمييز.
        حافظ على الإيجابية وقدم اقتراحاتك بطريقة مشجعة.
        مثال:
        بدلاً من القول "لا يوجد أجهزة مخصصة للألعاب القوية"، يمكن القول:
        "في القائمة الحالية، يوجد أجهزة بمواصفات ممتازه يمكنها تشغيل ألعاب بكفاءة."
        `,
      ],
      [
        "human",
